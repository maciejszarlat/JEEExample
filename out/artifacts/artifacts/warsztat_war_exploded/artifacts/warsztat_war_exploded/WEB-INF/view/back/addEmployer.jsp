            ...
            <div class="card card-login mx-auto mt-12">
                ...
                <div class="card-body">
                    <form action="/admin/employer/add" method="post">
                        ...
                        <div class="form-group">
                            <div class="form-label-group">
                                <input type="email" id="lastName" class="form-control" required="required" name="lastName">
                        ...
                        <div class="form-group">
                            <div class="form-label-group">
                                <input type="number" id="hourlyRate" class="form-control" required="required" name="hourlyRate">
