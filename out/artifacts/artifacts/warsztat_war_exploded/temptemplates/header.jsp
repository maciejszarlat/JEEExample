...
<head>
    ...
    <link href="<c:url value="/../assets/vendor/datatables/dataTables.bootstrap4.css" />" rel="stylesheet">
        ...
        <div class="input-group">
            <ul class="navbar-nav mr-auto">
                <c:choose>
                    ...
                    <c:otherwise>
                        <li class="nav-item active">
                            <a class="nav-link" href="/admin"><i class="fas fa-user"></i> ${sessionScope.userEmail}</a>
                        </li>
                        <li class="nav-item active">
